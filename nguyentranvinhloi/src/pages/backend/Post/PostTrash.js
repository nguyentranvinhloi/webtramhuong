...
//import ListPost from "../../../datatest/post.json";
      ...
      <div className="card-header">
        <div className="row">
          <div className="col-md-6">
            <strong className="text-danger">THÙNG RÁC BÀI ĐĂNG</strong>
          </div>
          <div className="col-md-6 text-end">
          <Link to="/admin/post" className="btn btn-sm btn-info me-1">
                Về danh sách
              </Link>
      ...
      <table className="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th style={{ width: 330 }} className="text-center">
                Mô tả
              </th>
              <th style={{ width: 130 }} className="text-center">
                Ngày tạo
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="text-center">
                    ...
                    <button onClick={()=>postRestore(post.id)} className="btn btn-sm btn-primary me-1">
