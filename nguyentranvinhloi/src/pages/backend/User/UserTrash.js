...
//import ListUser from "../../../datatest/user.json";
      ...
      <div className="card-header">
        <div className="row">
          <div className="col-md-6">
            <strong className="text-danger">THÙNG RÁC TÀI KHOẢN</strong>
          </div>
          <div className="col-md-6 text-end">
          <Link to="/admin/user" className="btn btn-sm btn-info me-1">
                Về danh sách
              </Link>
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="text-center">
                    ...
                    <button onClick={()=>userRestore(user.id)} className="btn btn-sm btn-primary me-1">
