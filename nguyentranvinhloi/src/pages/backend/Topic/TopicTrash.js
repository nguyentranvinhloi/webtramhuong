...
//import ListTopic from "../../../datatest/topic.json";
      ...
      <div className="card-header">
        <div className="row">
          <div className="col-md-6">
            <strong className="text-danger">THÙNG RÁC CHỦ ĐỀ</strong>
          </div>
          <div className="col-md-6 text-end">
          <Link to="/admin/topic" className="btn btn-sm btn-info me-1">
                Về danh sách
              </Link>
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="text-center">
                    ...
                    <button onClick={()=>topicRestore(topic.id)} className="btn btn-sm btn-primary me-1">
                    <FaEdit />
                    </button>
