        ...
        <div className="card-header">
          <div className="row">
            <div className="col-md-6">
              <strong className="text-danger">THÙNG RÁC THƯƠNG HIỆU</strong>
            </div>
                ...
                return (
                  <tr key={index}>
                    ...
                    >
                      ...
                      <button onClick={() => brandRestore(brand.id)} className="btn btn-sm btn-primary me-1">
