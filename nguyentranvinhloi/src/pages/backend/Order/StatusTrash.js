...
import { FaPlus, FaRegEye, FaEdit, FaRegTrashAlt, FaEye  } from "react-icons/fa";
//import ListOrder from "../../../datatest/order.json";
import orderservice from "../../../services/OrderService";
import { useEffect, useState } from "react";
import {urlImage} from '../../../config';

function StatusTrash() {
      ...
      <div className="card-header">
        <div className="row">
          <div className="col-md-6">
            <strong className="text-danger">TRẠNG THÁI BỊ ẨN</strong>
          </div>
            ...
            {orders.map(function (order, index) {
              return (
                <tr key={index}>
                  ...
                  <td className="text-center"><button onClick={()=>orderRestore(order.id)} className="btn btn-sm btn-warning">
                      <FaEye  />
                    </button></td>
                </tr>
              );
