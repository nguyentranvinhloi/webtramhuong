...
//import ListCategory from "../../../datatest/category.json";
        ...
        <div className="card-header">
          <div className="row">
            <div className="col-md-6">
              <strong className="text-danger">THÙNG RÁC DANH MỤC</strong>
            </div>
            <div className="col-md-6 text-end">
              <Link to="/admin/category" className="btn btn-sm btn-info me-1">
                Về danh sách
              </Link>
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="text-center">
                      ...
                      <button onClick={() => categoryRestore(category.id)} className="btn btn-sm btn-primary me-1">
